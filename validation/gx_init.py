...
class GXInitializer:
    ...
    def _create_expectation_suites(self):
        for topic in self.validation_config['validations']:
            suite_name = topic + "_expectation_suite"
    ...
    def _create_validation_definitions(self):
        for topic in self.validation_config['validations']:
            definition_name = topic + "_validation_definition"
            validation_definition = gx.ValidationDefinition(data=self.batch_definition, suite=self.suites[topic], name=definition_name)
